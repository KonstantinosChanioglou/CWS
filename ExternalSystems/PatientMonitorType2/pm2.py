...
@app.route('/temperature_type2', methods=['GET'])
...
@app.route('/respirationrate_type2', methods=['GET'])
...
@app.route('/heartrate_type2', methods=['GET'])
...
@app.route('/systolicBloodPressure_type2', methods=['GET'])
...
@app.route('/meanArterialPressure_type2', methods=['GET'])
...
@app.route('/receive-task_type2', methods=['POST'])
def receive_task():
