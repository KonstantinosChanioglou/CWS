...
public class RespirationRate {
    ...
    public static final String REQUEST_QUEUE = "respiration.request.queue";
    ...
    public void checkRespirationRate(JobClient client, ActivatedJob job) {
        System.out.println("UF: Requesting Respiration rate from external system...");
        this.latestJobKey = job.getKey();

        String requestMessage = "{\"request\":\"fetchRespirationRate\", \"jobKey\": " + job.getKey() + "}";
