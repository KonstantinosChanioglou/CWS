...
public class ImmuneCompromisation {
    ...
    public static final String REQUEST_QUEUE = "immunecompromization.request.queue";
    ...
    public void checkImmuneCompromization(JobClient client, ActivatedJob job) {
    ...
    public void receiveImmuneCompromizationResponse(String message) {
        System.out.println("UF: Received Immune Compromization response: " + message);

        Boolean isCompromised = Boolean.valueOf(message);
