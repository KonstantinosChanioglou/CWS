...
public class BloodPressure {
    ...
    public void bloodPressureTaking(ActivatedJob job) throws JsonProcessingException {
        ...
        String requestMessage = "{\"request\":\"fetchBloodPressure\", \"jobKey\": " + job.getKey() + ", \"patientId\": " + patientId + "}";
